...
function insertBlogPost() {
    ...
    // new element to edit blog post with icon
    ...
    // new element to delete blog post with icon
    ...
    newEditBtn.addEventListener("click", () => {
        ...
        // event listener for the save button in the new prompt dialog to save edits with icon
